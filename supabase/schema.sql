...
-- Separados de investment_lots porque no tienen plazo, vencimiento, cupón ni
-- retención Art. 24 LIF: no alimentan proyección, estimación fiscal ni análisis IA.
-- kind = 'NONE' marca un mes sin movimientos.
